...
test_that("create and delete work", {
  ...
  test_unique_proj <- paste0("create-exp-proj-", generate_random_id())
  test_experiment <- paste0("test-exp-", generate_random_id())

  exp <- create_experiment(experiment_name = test_experiment, project_name = test_unique_proj,
  ...
  wait_for("Experiment created", 20, function(){
    experiments_post <- get_experiments(project_name = test_unique_proj, api_key = test_api_key)[["experiments"]]
  ...
  wait_for("Experiment deleted", 20, function(){
    experiments_end <- get_experiments(project_name = test_unique_proj, api_key = test_api_key)[["experiments"]]
  ...
  delete_project(project_name = test_unique_proj, api_key = test_api_key)
})
